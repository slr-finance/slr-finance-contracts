...
export interface BaseInvestControllerInterface extends utils.Interface {
  functions: {
...
export interface BaseInvestController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseInvestControllerInterface;
