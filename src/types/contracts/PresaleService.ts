...
export interface PresaleServiceInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "discountDivider",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getCurrentPhaseCountdown",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getCurrentPhaseEndTime",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getMyDiscount",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "getPhasesAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getPhasesMaxAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getPhasesTime",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "joined",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "launchingTokenPrice",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "referralContractAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type SetDiscountEvent = TypedEvent<
  [string, BigNumber],
...
export type TryTransferEvent = TypedEvent<
  [string, string, BigNumber],
  TryTransferEventObject
>;

export type TryTransferEventFilter = TypedEventFilter<TryTransferEvent>;
...
export type UpdateRouterAddressEvent = TypedEvent<
  [string],
  UpdateRouterAddressEventObject
>;

export type UpdateRouterAddressEventFilter =
  TypedEventFilter<UpdateRouterAddressEvent>;

export interface UpdateTokenAddressEventObject {
  tokenAddress: string;
}
export type UpdateTokenAddressEvent = TypedEvent<
  [string],
  UpdateTokenAddressEventObject
>;

export type UpdateTokenAddressEventFilter =
  TypedEventFilter<UpdateTokenAddressEvent>;
...
export interface PresaleService extends BaseContract {
  ...
  functions: {
    ...
    getCurrentPhaseCountdown(
      overrides?: CallOverrides
    ): Promise<[number] & { countdown: number }>;

    getCurrentPhaseEndTime(
      overrides?: CallOverrides
    ): Promise<[number] & { endTime: number }>;

    getMyDiscount(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { myDiscount: BigNumber }>;
