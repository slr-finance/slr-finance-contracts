...
module.exports = {
  ...
  networks: {
    ...
    testnet: {
      provider: () => new HDWalletProvider(testnetMnemonic(), 'https://bsc.getblock.io/testnet/?api_key=b4bc2b22-f208-4279-85ad-7164fbe7caf1'),// `https://speedy-nodes-nyc.moralis.io/0580d6d62062ae83acf4c27e/bsc/testnet`),
      network_id: 97,
      confirmations: false,
    ...
    bsc: {
      provider: () => new HDWalletProvider(testnetMnemonic(), `https://bsc.getblock.io/mainnet/?api_key=b4bc2b22-f208-4279-85ad-7164fbe7caf1`),
      network_id: 56,
      confirmations: 0,
      timeoutBlocks: 3000,
      skipDryRun: true
